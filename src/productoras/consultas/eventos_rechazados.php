...
<form action="eventos_rechazados.php" method="post">
<table>
...
$query = "SELECT * from propuestas WHERE propuestas.productora = '$productora' and propuestas.estado = 'rechazado' ORDER BY propuestas.inicio;";
